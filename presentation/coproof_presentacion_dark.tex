%% ============================================================
%% CoProof — Presentación de Proyecto II  (v3 — Story Arc — DARK)
%% Compilar: pdflatex coproof_presentacion_dark.tex
%% ============================================================
...
\definecolor{cpBlue}{RGB}{100, 160, 255}
\definecolor{cpTeal}{RGB}{60, 210, 180}
\definecolor{cpAccent}{RGB}{255, 130, 50}
\definecolor{cpLight}{RGB}{40, 48, 62}
\definecolor{cpGray}{RGB}{180, 180, 180}
\definecolor{leanpurple}{RGB}{200, 150, 255}
\definecolor{darkbg}{RGB}{22, 27, 36}
\definecolor{darkframe}{RGB}{30, 37, 50}

\usetheme{default}
\usecolortheme[named=cpBlue]{structure}

\setbeamercolor{frametitle}{fg=cpBlue, bg=darkframe}
\setbeamerfont{frametitle}{series=\bfseries, size=\large}
\setbeamertemplate{frametitle}{%
  \vspace{0.4em}%
  \insertframetitle\par%
  \vspace{0.15em}{\color{cpBlue!60}\hrule height 0.8pt}\vspace{0.2em}%
}
...
\setbeamercolor{block title}{fg=darkbg, bg=cpBlue}
\setbeamercolor{block body}{fg=white, bg=cpLight}
\setbeamercolor{alertblock title}{fg=darkbg, bg=cpAccent}
\setbeamercolor{alertblock body}{fg=white, bg=cpAccent!25}
\setbeamercolor{alerted text}{fg=cpAccent}
\setbeamercolor{background canvas}{bg=darkbg}
\setbeamercolor{normal text}{fg=white, bg=darkbg}
\setbeamercolor{item}{fg=cpTeal}
\setbeamercolor{enumerate item}{fg=cpAccent}
...
\begin{document}
% ============================================================
% Dark mode: default TikZ node text to white (explicit \color{} still overrides)
\tikzset{every node/.append style={text=white}}
...
\begin{frame}
  ...
  \vspace{0cm}
  \begin{center}
    \includegraphics[height=5.5cm]{img/logo_dark_bg_text.pdf}\\[0.5em]
    {\color{cpGray}\large Plataforma colaborativa de demostraci\'{o}n formal de teoremas}\\[1.0em]
    \textcolor{cpBlue!60}{\rule{\textwidth}{0.6pt}}\\[0.8em]
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{tikzpicture}[scale=0.88,
        ...
        \node[lbox, fill=cpTeal!50!darkbg] (c) at (0,-0.5)
  ...
  \begin{columns}[T]
    \begin{column}{0.43\textwidth}
      ...
      \begin{tikzpicture}[scale=0.80,
        ...
        \node[hnode, fill=cpBlue!45!darkbg] (asm) at (0, 0) {Ensamblar};
    ...
    \begin{column}{0.50\textwidth}
      ...
      \begin{tikzpicture}[scale=0.80,
          pnode/.style={draw, rounded corners=3pt,
                        ...
                        align=center, font=\footnotesize},
          arr/.style={->, thick, color=cpBlue!60}]
        \node[pnode, fill=cpBlue!45!darkbg] (root) at (0, 0)    {Teorema ra\'{i}z};
        \node[pnode, fill=cpTeal!45!darkbg] (la)  at (-3.0,-1.2){Lema A};
        \node[pnode, fill=cpTeal!45!darkbg] (lb)  at ( 0.0,-1.2){Lema B};
        \node[pnode, fill=cpTeal!45!darkbg] (lc)  at ( 3.0,-1.2){Lema C};
        \node[pnode, fill=green!45!darkbg]  (ba)  at (-3.0,-2.4){\yes\ base};
        \node[pnode, fill=green!45!darkbg]  (bc)  at ( 3.0,-2.4){\yes\ base};
        \node[pnode, fill=yellow!40!darkbg] (bb)  at ( 0.0,-2.4){pendiente};
...
\begin{frame}{Automatizando la Formalización con Lean 4}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.50\textwidth}
      ...
      \colorbox{darkframe}{\parbox{\linewidth}{%
  ...
  \begin{columns}[T, onlytextwidth]
    ...
    \begin{column}{0.32\textwidth}
      ...
      \begin{tikzpicture}[scale=0.85,
          ...
          arr/.style={->, thick}]
        \node[nd, fill=red!45!darkbg] (a) at (0, 0) {pendiente};
        \draw[arr, color=cpAccent, line width=1.5pt] (0,-0.42) -- (0,-0.88);
        \node[font=\small\bfseries, color=cpAccent] at (0.9,-0.65) {Split};
        \node[nd, fill=red!45!darkbg] (r)  at (0,-1.3)  {pendiente};
        \node[nd, fill=red!45!darkbg] (c1) at (-1.6,-2.5){sub-lema A};
        \node[nd, fill=red!45!darkbg] (c2) at ( 1.6,-2.5){sub-lema B};
    ...
    \begin{column}{0.32\textwidth}
      ...
      \begin{tikzpicture}[scale=0.85,
          nd/.style={draw, rounded corners=3pt, minimum width=2.0cm,
                     minimum height=0.55cm, align=center, font=\small},
          arr/.style={->, thick}]
        \node[nd, fill=red!45!darkbg] (c) at (0, 0) {pendiente};
        ...
        \node[nd, fill=red!45!darkbg]  (cp) at (0,-1.3) {pendiente};
        \node[nd, fill=orange!45!darkbg, draw=orange!60!black]
...
\begin{frame}{Arquitectura}
  ...
  \begin{tikzpicture}[scale=0.82, every node/.style={font=\footnotesize},
    ...
    \node[box, fill=blue!45!darkbg]    (fe)    at (-3.8, 1.5) {Angular\\Frontend};
    \node[box, fill=cpBlue!45!darkbg]  (api)   at ( 0.0, 1.5) {Flask API\\+ SocketIO};
    \node[box, fill=gray!50!darkbg]    (gh)    at ( 3.8, 1.5) {GitHub};
    \node[box, fill=yellow!35!darkbg]  (db)    at (-2.5, 0.0) {PostgreSQL};
    \node[box, fill=red!45!darkbg]     (redis) at ( 0.5, 0.0) {Redis\\(Broker)};
    \node[box, fill=green!45!darkbg]   (hpc)   at ( 3.8, 0.0) {Cl\'{u}ster RPi $\times$4\\OpenMPI};
    \node[box, fill=cpTeal!45!darkbg]  (lean)  at (-4.4,-1.5) {Lean\\Worker};
    \node[box, fill=orange!45!darkbg]  (nl2fl) at (-1.6,-1.5) {NL2FL\\Worker};
    \node[box, fill=purple!50!darkbg]  (ag)    at ( 1.2,-1.5) {Agents\\Worker};
    \node[box, fill=red!40!darkbg]     (comp)  at ( 3.9,-1.5) {Computation\\Worker};
      ...
      \begin{tikzpicture}
        \begin{axis}[
          ...
          legend style={font=\tiny, at={(0.04,0.97)},
                        anchor=north west, draw=none, fill=darkbg, text=white,
                        row sep=-2pt},
          axis lines=left,
          clip=true,
        ]
  ...
  \begin{tikzpicture}[
    ...
    \node[rnode, fill=green!45!darkbg]
      (ng)  at ( 2.5, 0.0) {\yes\ \texttt{n\_gt\_}\\
                             \texttt{sum\_bound}};
    \node[rnode, fill=orange!45!darkbg, draw=orange!60]
...
\begin{frame}{Demo}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}
      ...
      \vspace{0.3cm}
      \centering
      \includegraphics[height=3.2cm]{img/logo_dark_bg.pdf}
    \end{column}
  \end{columns}
\end{frame}
